...
//             <div className="header-sala3">
//                     <h1>Cine-Zile</h1>
//                 </div>

//             <div className="container-sala3">

//                 <div className="infos-sala3">

//                     <h1 className="texto_nome-sala3">Sala 3 </h1>
...
//                     <button  className="botao-sala3" onClick={ingressos}>Comprar Ingresso</button>
//                 </div>
//             </div>
//         </div>
//     )
