...
//             <div className="header-sala2">
//                     <h1>Cine-Zile</h1>
//                 </div>

//             <div className="container-sala2">

//                 <div className="infos-sala2">

//                     <h1 className="texto_nome-sala2">Sala 2 </h1>
...
//                     <button  className="botao-sala2" onClick={ingressos}>Comprar Ingresso</button>
//                 </div>
//             </div>
//         </div>
//     )
