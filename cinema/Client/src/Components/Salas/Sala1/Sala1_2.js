    ...
    useEffect(() => {
        axios.get("http://localhost:3006/")
            ...
            .then((response) => {
                ...
                SetSala(response[1]["NUMERO_SALA"])
                SetCapacidade(response[1]["CAPACIDADE"])
                SetHorario(response[1]["HORARIO"])
                SetFaturamento(response[1]["FATURAMENTO"])
                SetCor(response[1]["COR"])
                SetId(response[1]["IDSALAS"])
        ...
        axios.get("http://localhost:3006/Filmes")
            ...
            .then((response) => {
                console.log(response[1])
                SetProgramacao(response[1]["FILME"])
                SetDuracao(response[1]["DURACAO"])
                setTeste(response[1]["SINOPSE"])
        ...
        axios.get("http://localhost:3006/Ingresso")
            ...
            .then((response) => {
                console.log(response[1])
                SetIngressodips(response[1]["INGRESSOSDISP"])
                SetIngressosvend(response[1]["INGRESSOSVEND"])
